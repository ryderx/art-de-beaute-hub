...
const translations = {
  fr: {
    ...
    'services.treatments.nail.pedicure.name': 'Pédicure Deluxe',
    ...
    'services.treatments.nail.gel.description': 'Vernis gel longue durée avec brillance et durabilité parfaites',
    ...
    'gallery.filters.training': 'Formation',
  ...
  es: {
    ...
    'gallery.filters.training': 'Formación',
  ...
  en: {
    ...
    'gallery.filters.training': 'Training',
