      ...
      <div className="beauty-container flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 md:hidden">
          <div className="relative inline-block">
            <button className="flex items-center text-beauty-darkpink hover:text-beauty-gold" aria-label="Language" onClick={e => {
            e.stopPropagation();
          ...
          <button onClick={toggleMenu} className="text-beauty-darkpink hover:text-beauty-gold transition-colors" aria-label="Toggle menu">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          <a href="https://www.kalendes.com/site/artdelabeaute/reserve" target="_blank" rel="noopener noreferrer" className="beauty-button">
            {t('nav.bookNow')}
          </a>
        </div>
        ...
        <div className={`fixed inset-0 z-50 bg-white transform ${isOpen ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 ease-in-out md:hidden`}>
          <div className="flex justify-between items-center p-6 border-b border-beauty-pink">
            ...
            <button onClick={toggleMenu} className="text-beauty-darkpink" aria-label="Close menu">
              <X size={24} />
            </button>
          </div>
          <div className="flex flex-col items-center pt-10 space-y-8">
            ...
            <a href="https://www.kalendes.com/site/artdelabeaute/reserve" target="_blank" rel="noopener noreferrer" className="beauty-button mt-8" onClick={closeMenu}>
              {t('nav.bookNow')}
            </a>
          </div>
        </div>
